...
ElementsTable.Toggle = (function()
	...
	function Element:New(Idx, Config)
		...
		Toggle.GetTitle = ToggleFrame.GetTitle
		Toggle.GetDesc = ToggleFrame.GetDesc
...
if ToggleLib then
	...
	Background.Icon.Image = "rbxassetid://0"

	function SwapIco()
		if not Fluent.Window.Minimized then
			Background.Icon.Image = "rbxassetid://0"
		else
			Background.Icon.Image = "rbxassetid://0"
		end
	...
	Background.MouseButton1Click:Connect(function()
		if not Fluent or not Fluent.Window then return end
